...
public class Level2 {
	private final int store1X = 70;
	private final int store1Y = 700;
	private final int store2X = 435;
	private final int store2Y = 400;
	private final int store3X = 820;
	private final int store3Y = 300;
	...
	public void drawMe(Graphics g, Item[] items) {
		if(scene == 0) {
			try {                
	        	...
	        	g.drawImage(road, 170, 0, null);
	        	g.drawImage(road, 600, 0, null);
			...
			try {  
				BufferedImage tile = ImageIO.read(new File("tile2.jpg"));              
		...
		if(scene == 1) {
			try {  
	       	...
	       	if(buttonClicked == 1) {
	       		...
	       		if(items[0] != null && items[0].getName().equals("Engine 1")) {
			...
			try {  
	       	...
	       	if(buttonClicked == 1) {
	       		...
	       		if(items[2] != null && items[2].getName().equals("Card 1")) {
	       		...
	       		if(items[1] != null && items[1].getName().equals("iPhone 1")) {
			...
			try {  
	       	...
	       	if(buttonClicked == 1) {
	       		...
	       		if(items[3] != null && items[3].getName().equals("Battery 1")) {
